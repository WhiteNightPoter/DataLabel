...
switch flag
    case 1
        str = {'左超车','右超车','前方车辆减速','左向驶离车道','右向驶离车道','左向驶入车道','右向驶入车道','加速直行'};
        handles.CarAction.String = str;
    case 2
        str = {'正前方车辆减速','左向驶离车道','左向驶入车道','加速直行'};
        handles.CarAction.String = str;
    case 3
        str = {'正前方车辆减速','左向驶离车道','右向驶离车道','左向驶入车道','右向驶入车道','加速直行'};
        handles.CarAction.String = str;
    case 4
        str = {'左超车','右超车','正前方车辆减速','左向驶离车道','右向驶离车道','左向驶入车道','右向驶入车道','加速直行'};
        handles.CarAction.String = str;
        str = {'沿路边直行跑步靠近','沿路边直行慢步靠近','左向跑步横穿','左向慢步横穿','右向跑步横穿','右向慢步横穿','驻停'};
        handles.PedAction.String = str;
    case 5
        str = {'正前方车辆减速','左向驶离车道','左向驶入车道','加速直行'};
        handles.CarAction.String = str;
        str = {'左向跑步横穿','左向慢步横穿','右向跑步横穿','右向慢步横穿','驻停'};
        handles.PedAction.String = str;
    case 6
        str = {'正前方车辆减速','加速直行'};
        handles.CarAction.String = str;
